...
const svgBase = "h-6 w-6";

const icons: Record<IconName, React.ReactNode> = {
  trendingUp: (
    <svg className={svgBase} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RegionalIcon({ name, className }: { name: string; className?: string }) {
