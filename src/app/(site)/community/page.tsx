  ...
  return (
    <>
      ...
      <Section className="pt-12 pb-16">
        <Container>
          <div className="text-center mb-12">
            <Tag variant="accent">Why Join</Tag>
      ...
      <Section className="py-16 bg-cyan-field">
        <Container>
          <div className="text-center mb-12">
            <Tag variant="accent">Simple Process</Tag>
            <Heading level={2} className="mt-4 text-3xl sm:text-4xl">
              How It Works
            </Heading>
          </div>
      ...
      <Section className="py-16">
        <Container>
          <div className="text-center mb-12">
            <Tag variant="accent">Member Stories</Tag>
            <Heading level={2} className="mt-4 text-3xl sm:text-4xl">
              What Members Say
            </Heading>
          </div>
      ...
      <FAQSection
        ...
        subtitle="Everything you need to know about joining the TwoApps Community"
        items={faqs}
      />
        ...
        <Container>
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              <Tag variant="accent">Join Now</Tag>
              <Heading level={2} className="mt-4 text-3xl sm:text-4xl">
                Request Access
              </Heading>
