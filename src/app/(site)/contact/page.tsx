  ...
  return (
    <>
      ...
      <Section className="pt-6 sm:pt-8 lg:pt-12">
        <div className="grid gap-4 sm:gap-5 lg:gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <Card
            className="order-2 p-6 sm:p-8 lg:order-1"
            data-bot-stop
            data-bot-fx="0.88"
                ...
                {contactPhone && (
                  <>
                    ...
                    <a
                      ...
                      className="block text-blue hover:text-blue/80 transition-colors"
                    >
                      {contactPhone}
                    </a>
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-blue hover:text-blue/80 transition-colors"
                    >
