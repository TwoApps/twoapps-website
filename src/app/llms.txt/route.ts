...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    "## Pricing (USD)",
    "",
    "- Workflow Assessment: $8,000 (2 weeks)",
    "- Lead Qualification Workflow: $10,000 (1 week)",
    "- Customer Support Automation: $12,000 (2 weeks)",
    "- Finance Reporting Automation: $15,000 (2 weeks)",
    "- AI Governance Audit: $20,000 (3 weeks)",
    "- Compliance-as-a-Service: $5,000 / month (6-month minimum)",
    `- See full pricing: ${siteUrl}/pricing`,
    "",
    "## Industries",
    "",
    ...industries.map(
