...
export const aeConfig: RegionalConfig = {
  slug: "ae",
  meta: {
    title: "AI Workflow Automation UAE | Vision 2030 Aligned | TwoApps",
    description:
      "Deliver on Vision 2030. Start today. AI workflow automation for GCC organizations facing transformation mandates and rapid scaling needs.",
    keywords: [
      "AI automation UAE",
      "workflow automation GCC",
      "Vision 2030 automation",
      "Dubai AI solutions",
      "government automation UAE",
